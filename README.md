...
4. Crie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`: `git checkout -b feat/community/spatricio`;
    > Exemplo: `git checkout -b feat/community/spatricio`
